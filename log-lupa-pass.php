    ...
    <div class="content-box">
        ...
        <form action="log-login.php" method="post">
            ...
            <div class="container-btn">
                <button class="btnn" type="submit"><a style="color: white;" href="main.php">Kirim Code</a></button>
            </div>
        </form>
    </div>
    <div style="text-align: right; border-radius: 10px; font-size: 10px; margin-top: 90px;">
