...
$sql = "SELECT UserID, Username, namalengkap, Email, Password FROM users WHERE lvl = 1 LIMIT $limit OFFSET $offset";
...
$totalResult = $conn->query("SELECT COUNT(*) AS count FROM users WHERE lvl = 1");
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="list-group list-group-flush account-settings-links">
            ...
            <a class="list-group-item list-group-item-action active" href="data-admin.php">Data Admin</a>
