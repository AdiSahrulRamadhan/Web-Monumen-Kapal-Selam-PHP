...
if (isset($_SESSION['UserID'])) {
    // Jika sudah, arahkan ke halaman yang sesuai dengan level akun
    if ($_SESSION['lvl'] == '1') {
        header("Location: Admin/main.php");
        exit;
    } elseif ($_SESSION['lvl'] == '2' || $_SESSION['lvl'] == '0') {
...
if (isset($_POST['submit'])) {
    ...
    // Query ke database untuk mencari user dengan username yang sesuai
    ...
    if ($result) {
        ...
        if ($hasil && password_verify($password, $hasil['Password'])) {
            // Atur sesi dan arahkan pengguna ke halaman yang sesuai
            $_SESSION['Username'] = $hasil['Username'];
            $_SESSION['UserID'] = $hasil['UserID'];
            $_SESSION['lvl'] = $hasil['lvl']; // Simpan level akun di sesi

            if ($hasil['lvl'] == '1') {
                // Jika akun adalah admin, arahkan ke halaman admin
                header("Location: Admin/main.php");
                exit;
            } elseif ($hasil['lvl'] == '2' || $hasil['lvl'] == '0') {
                // Jika akun adalah user biasa, arahkan ke halaman utama
                header("Location: main.php");
                exit;
            }
        } else {
...
<div class="content"> 
    <div class="content-box">
        <h1 style="margin-bottom: 0;">Login Akun</h1>
        ...
        <p><a style="color: green;" href="log-sign-up.php">Belum Punya Akun ?</a></p>
        <a id="lupapas" style="color: lightcoral; ;" href="lupa-password.php">Lupa Password ?</a>
    </div>
